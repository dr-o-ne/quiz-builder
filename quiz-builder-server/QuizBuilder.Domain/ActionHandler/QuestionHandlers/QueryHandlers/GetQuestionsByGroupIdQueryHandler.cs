...
namespace QuizBuilder.Domain.ActionHandler.QuestionHandlers.QueryHandlers {
	...
	public sealed class GetQuestionsByGroupIdQueryHandler: IQueryHandler<GetQuestionsByGroupIdQuery, QuestionsQueryResult> {
		...
		public async Task<QuestionsQueryResult> HandleAsync( GetQuestionsByGroupIdQuery query ) {
